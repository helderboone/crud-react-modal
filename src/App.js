...
function App() {
  ...
  return (
    <div className="App">
      ...
      <header>
        <button className='btn btn-success' onClick={() => abrirFecharModalIncluir()}>Inserir Novo Aluno</button>
      </header>
      ...
      <Modal isOpen={modalExcluir}>        
        <ModalBody>
          Confirma exclusao deste aluno? {alunoSelecionado && alunoSelecionado.nome}
        </ModalBody>
        <ModalFooter>
